...
//    if ( prePayid != nil) {
        ...
        [signParams setObject: dic[@"appid"]        forKey:@"appid"];
        [signParams setObject: dic[@"noncestr"]    forKey:@"noncestr"];
        [signParams setObject: dic[@"package"]      forKey:@"package"];
        [signParams setObject: dic[@"partnerid"]        forKey:@"partnerid"];
        [signParams setObject: [NSString stringWithFormat:@"%@",dic[@"timestamp"]]   forKey:@"timestamp"];
        [signParams setObject: dic[@"prepayid"]     forKey:@"prepayid"];
